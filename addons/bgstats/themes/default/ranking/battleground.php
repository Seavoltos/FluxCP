...
<h2><?php echo Flux::message('BGRanklabel') ?></h2>
<?php if ($chars): ?>
...
<?php echo $paginator->infoText() ?>
	...
	<table class="horizontal-table">
		...
		<tr style="text-align: center;">
			...
			<td>
				<a title="Ver estadísticas" href="<?=$this->url('bgstats', 'player_bg', array('player_id' => $char->char_id))?>"><?=htmlspecialchars($char->name)?></a>
			</td>
			<td>
